...
class TestUsers(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.newUser = Users()
        self.register = self.newUser.user_register("waweru@gmail.com", "mwaz", "password", "password")

    def test_user_email_exists_on_register(self):
        """ Test to if user email exists on register """
        self.register
        result = self.newUser.user_register("waweru@gmail.com", "mwaze", "password", "password")
        self.assertIn("401,Email exists", result, "401,Email exists")

    def test_user_register_success(self):
        """ Test to test function user_register """
        result = self.newUser.user_register("waweruhm@gmail.com", "mwazz", "password6", "password6")
    ...
    def test_invalid_member_email(self):
        ...
        result = self.newUser.user_register("waweru.waweru.com", "mwaz", "password", "password")
    ...
    def test_null_member(self):
        ...
        result = self.newUser.user_register("waweru@gmail.com", "", "password", "password")
        self.assertIn("205,Invalid input", result, "205,Invalid input")

    def test_null_password(self):
        """Test to check if email is null"""
        result = self.newUser.user_register("waweru@gmail.com", "mwaz", "", "password")
        self.assertIn("205,Invalid input", result, "205,Invalid input")
    ...
    def test_cpassword_is_equal_to_password(self):
        ...
        result = self.newUser.user_register("wawerum@gmail.com", "mwaz2", "password", "pass")
    ...
    def test_invalid_member_name(self):
        ...
        member_registration = self.newUser.user_register("waweru@gmail.com", "&#*", "password", "password")
    ...
    def test_existing_member_email(self):
        ...
        self.register
        result = self.newUser.user_register("waweru@gmail.com", "mwaz", "password2", "password2")
        self.assertIn("401,Email exists", result, "401,Email exists")
